...
abstract class zoneStim{
	...
	protected abstract void startStimZone(myZonePoint _p, float _modAmt);
	//actual stimulation of zone
	protected abstract void stimZone(myZonePoint _p,float _modAmt);
}//class zoneStim

class kinZoneStim extends zoneStim{
	public kinZoneStim() {	super();}
	@Override
	protected void startStimZone(myZonePoint _p,float _modAmt) {//special setup to perform for this type of stimulation function
		_p.stimulateZoneKin(_modAmt);
	}
	@Override
	protected void stimZone(myZonePoint _p,float _modAmt) {_p.stimulateZoneKin(_modAmt);}
}//class kinZoneStim
...
class dynZoneStim extends zoneStim{
	...
	@Override
	protected void stimZone(myZonePoint _p,float _modAmt) {_p.stimulateZoneForce(_modAmt);}
}//class dynZoneStim
...
class jumpZoneStim extends zoneStim{//starts with kinematic displacement, then continues with dynamic mass-spring
	...
	@Override
	protected void startStimZone(myZonePoint _p,float _modAmt) {//special setup to perform for this type of stimulation function - kinematic displacement
		_p.stimulateZoneKin(_modAmt);
	}
	@Override
	protected void stimZone(myZonePoint _p,float _modAmt) {_p.stimulateZoneForce(_modAmt);}
