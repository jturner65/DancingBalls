...
public class my3DCanvas {
    ...
    public my3DCanvas(DancingBalls _p) {
        p = _p;
...
class edge{ 
    public DancingBalls p;
    public myPoint a, b;
    public edge (DancingBalls _p){this(_p,new myPoint(0,0,0),new myPoint(0,0,0));}
    public edge (DancingBalls _p, myPoint _a, myPoint _b){p = _p;a=new myPoint(_a); b=new myPoint(_b);}
